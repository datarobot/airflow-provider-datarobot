...
using a preconfigured "DataRobot Azure Storage Credentials" from Airflow Connection.
...
def datarobot_azure_storage_batch_scoring(deployment_id="put_your_deployment_id"):
