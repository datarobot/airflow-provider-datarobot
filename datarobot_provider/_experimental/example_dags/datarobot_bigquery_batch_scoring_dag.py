...
"""
Example of Aiflow DAG for DataRobot Batch Scoring using BigQuery as source and destination,
...
def datarobot_bigquery_batch_scoring(deployment_id=None):
    ...
    (get_bigquery_credentials_op >> score_predictions_op >> scoring_complete_sensor)


datarobot_bigquery_batch_scoring_dag = datarobot_bigquery_batch_scoring()
