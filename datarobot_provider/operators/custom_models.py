...
class CreateExecutionEnvironmentVersionOperator(BaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        docker_context_path: str | None = None,
        environment_version_label: str | None = None,
        environment_version_description: str | None = None,
...
class CreateCustomModelVersionOperator(BaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        custom_model_folder: str | None = None,
...
class CreateCustomModelDeploymentOperator(BaseOperator):
    ...
    def __init__(
        ...
        *,
        custom_model_version_id: str,
        deployment_name: str,
        prediction_server_id: str | None = None,
        description: str | None = None,
