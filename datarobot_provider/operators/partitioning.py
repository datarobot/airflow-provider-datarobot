...
class SetDatetimePartitioningOperator(BaseDatarobotOperator):
    """
    ...
    def execute(self, context: Context) -> str:
        ...
        if project.target:
            ...
            datetime_partition_spec = DatetimePartitioningSpecification(
            ...
            project.set_datetime_partitioning(datetime_partition_spec=datetime_partition_spec)
