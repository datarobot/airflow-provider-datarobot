...
This flow is similar to`datarobot_provider/examples/hospital_readmissions_example.py`, except that the `hospital_readmissions_example` DAG trains a single model based on the model 
type and uses the manual mode.
